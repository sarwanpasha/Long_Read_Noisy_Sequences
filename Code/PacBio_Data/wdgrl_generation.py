...
dataset_name = "OHE_depth_10_red_seq_new_8220"

Xxxx_1 = np.load("/alina-data1/sarwan/Adversarial_Attack/Feature_Vectors/" + dataset_name + ".npy",allow_pickle=True)
...
for i in range(len(attributes_1)):
    asd = attributes_1[i]
    asd_1 = asd[1]
    attributes.append(asd_1[0:8172])
...
np.save("/alina-data2/Sarwan/ISBRA_Adversarial_Attack/Dataset/Vectors/PacBio_WDRGL_" + dataset_name + ".npy",X_full)
######################
