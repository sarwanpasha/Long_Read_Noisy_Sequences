...
data_path = "/alina-data1/sarwan/Adversarial_Attack/Dataset/"


dataset_name_arr = "depth_10_red_seq_new_8220"

seq_data_tmp_1 = np.load(data_path + dataset_name_arr + ".npy")
seq_data_tmp = seq_data_tmp_1[0:8172]
...
np.save("/alina-data2/Sarwan/ISBRA_Adversarial_Attack/Dataset/Vectors/PacBio_Spaced_kmers_g_" + str(gmer_length) + "_k_" + str(spaced_kmer_length)  + "_" + dataset_name_arr + ".npy",frequency_vector)
