...
for seq_record in SeqIO.parse("/alina-data2/Bikram/GISAID/pbsim_pipeline/gisaid_hcov-19.fasta","fasta"):
	...
	cmd = 'badread simulate --reference seq_'+str(i)+'.fasta --quantity 10x --error_model nanopore2020 --qscore_model nanopore2020 --identity 85,95,3 --length 7500,7500 | gzip > sd_0001.fastq.gz'
	os.system(cmd)
	...
	cmd12 = 'cat out_'+str(i)+'.fa >> n2020_10x_simulated_error.fasta'
	os.system(cmd12)
